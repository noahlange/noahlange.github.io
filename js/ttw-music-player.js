...
(function($) {
    $.fn.ttwMusicPlayer = function(playlist, userOptions) {
        ...
        playlistMgr = function() {
            ...
            function buildPlaylist() {
                ...
                for (var j = 0; j < myPlaylist.length; j++) {
                    ...
                    $track.find(cssSelector.album).html(albumName(j));
        ...
        interfaceMgr = function() {
            ...
            var $player, $title, $artist, $albumCover, $album;
            ...
            function buildInterface() {
                ...
                markup = '<div class="ttw-music-player">' +
                        ...
                        '<a class="toggle-tracks" onClick="toggleTracks()"><i class="fa fa-bars"></i></a>' +
        ...
        function albumName(index) {
            if (!isUndefined(myPlaylist[index].album))
                return myPlaylist[index].album;
            else return '';
        }
